...
namespace OATools2018.CommonTools.AutoSectionView
{
    /// <summary>
    ...
    public class Command : IExternalCommand
    {
        ...
        public Autodesk.Revit.UI.Result Execute(ExternalCommandData commandData, ref string message, Autodesk.Revit.DB.ElementSet elements)
        {
            try
            {
                ...
                section.get_Parameter(BuiltInParameter.VIEW_DETAIL_LEVEL).Set(3);
        ...
        Boolean GetSelectedElement()
        {
           ...
           ElementSet collection = new ElementSet();
            ...
            {
                m_errorInformation =
                    "Please select only one element.";
                return false;
            }
            ...
            if (m_currentComponent is Duct)
            {
                m_type = SelectType.DUCT;      // when the element is a duct.
                return true;
            }

            // If it is not a wall, a beam or a floor, give error information.
            m_errorInformation = "Please select an element, such as a duct, pipe, wall, beam or a floor.";
            return false;
        }
        ...
        Transform GenerateTransform()
        {
            ...
            else if (SelectType.DUCT == m_type)
            {
                return GenerateDuctTransform();
            }
            else
            {
