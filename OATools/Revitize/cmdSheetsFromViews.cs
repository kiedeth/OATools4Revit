...
namespace OATools2018.Revitize
{
    ...
    public class cmdSheetsFromViews : IExternalCommand
    {
        //Create the var to make it visible to this class
        //List<Autodesk.Revit.DB.View> receivedCreatedViews = new List<Autodesk.Revit.DB.View>();
        ...
        public Autodesk.Revit.UI.Result Execute(Autodesk.Revit.UI.ExternalCommandData commandData, ref string message, Autodesk.Revit.DB.ElementSet elements, ViewSet createdViewList)
        {
            ...
            try
            {
                ...
                //set the created views
                //receivedCreatedViews = createdViewList;

                Document doc = commandData.Application.ActiveUIDocument.Document;
                ViewsMgr view = new ViewsMgr(doc, createdViewList);

                newTran = new Transaction(doc);
                newTran.Start("AllViews_Sample");

                frmCreateAddViewsToSheet dlg = new frmCreateAddViewsToSheet(view);
    ...
    public class ViewsMgr
    {
        ...
        private ViewSet receivedCreatedViews = new ViewSet();
        ...
        private void GetAllViews(Document doc)
        {
            ...
            {
                ElementType objType = doc.GetElement(v.GetTypeId()) as ElementType;
                ...
                {
                    m_allViews.Insert(v);
                    AssortViews(v.Name, objType.Name);
                }
            }
