...
namespace OATools.Electrical
{
    ...
    class cmdEmergencyCircut : IExternalCommand
    {
        ...
        BuiltInCategory[] targets = new BuiltInCategory[] { BuiltInCategory.OST_Wire };
          ...
          BuiltInCategory target)
        {
            ...
            if (target.Equals(BuiltInCategory.OST_IOSModelGroups))
            {
                ...
                FilteredElementCollector collector = Util.GetElementsOfType(doc, typeof(Group), BuiltInCategory.OST_Wire);
        ...
        /// <returns></returns>
        bool CreateSharedParameter(Document doc, Category cat, int nameSuffix, bool typeParameter)
        {
            ...
            if (null == file)
            {
                Util.ErrorMsg("Please define a Shared Parameter file for the project.");
        ...
        bool setParameterValue(ExternalCommandData commandData)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    foreach (ElementId id in selectedIds)
                    {
                        ...
                        {
                            if (param.Definition.Name.Contains("Emergency"))
                            {
                                param.Set(1);
                            }
                        }
        ...
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            using (Transaction t = new Transaction(doc))
            {
                ...
                bool result = setParameterValue(commandData);

                cmdCreateViewFilter.CreateViewFilter(doc, uidoc.ActiveView);

                // create a type parameter:

                //cat = GetCategory(doc, BuiltInCategory.OST_Wire);
